...
[NOTE]
====
Alternatively, you can generate a CSR file using a tool such as OpenSSL and can skip to xref:task_step_2_submit_the_csr_files.adoc[Step 2: Submit the CSR files].
====
...
Go to xref:task_step_2_submit_the_csr_files.adoc[Step 2: Submit the CSR files].
