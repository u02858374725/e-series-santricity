...
When the CA returns the signed certificates, go to link:step-3-import-signed-certificates-for-the-controllers.html[Step 3: Import signed certificates for controllers].
