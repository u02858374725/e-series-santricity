...
_In progress. Not yet reviewed._
...
a|FIPS 140-3 level drives can now co-exist with FIPS 140-2 level drives (NVMe and SAS). When using a mixture of these levels in volume groups and disk pools, be aware that the group or pool will then operate at the lower level of security (140-2).

a|EF600 and EF300 SAS expansion support
a|This release provides support for 100 Gb/s HICs on EF300 and EF600 storage systems to allow for SAS expansion.
...
a|Access Tokens
a|This release includes a new feature for creating access tokens to authenticate with the REST API or command line interface (CLI), without exposing user names and passwords. This feature is provided in the Access Management section.
