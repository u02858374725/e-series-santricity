...
* Drive types should be the same on primary and secondary, either both NVMe drives or both non-NVMe drives. Mixing of 4K NVMe and SAS based SSD/HDD drive groups between primary and secondary is not supported.
...
* Mixing of 4K NVMe and SAS-based SSD/HDD drive groups between base and repository is not supported.
