...
* The physical and logical block size of the primary and secondary volumes must match.
...
* The logical block size of the drives used to create the reserved capacity volume must match the logical block size of the drives used to create the associated primary or secondary mirror volume.
