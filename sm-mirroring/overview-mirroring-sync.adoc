...
* link:synchronous-mirroring-terminology.html[Synchronous mirroring terms]
...
You must perform the initial configuration between the arrays in the Unified Manager interface. Once it is configured, you can manage mirrored pairs in System Manager.
