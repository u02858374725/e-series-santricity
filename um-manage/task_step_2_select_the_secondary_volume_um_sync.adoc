---
permalink: um-manage/task_step_2_select_the_secondary_volume_um_sync.html
sidebar: sidebar
keywords: 
...
. Click *Next* and go to link:task_step_3_select_sync_settings_um_sync.md#[Step 3: Select synchronization settings].
