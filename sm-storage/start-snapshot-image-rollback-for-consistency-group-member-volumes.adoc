...
sidebar: sidebar
keywords: start, snapshot, image, rollback, snapshot, consistency, group, member, volumes
...
* <<Step 1: Select members,Step 1: Select members>>
* <<Step 2: Review capacity,Step 2: Review capacity>>
* <<Step 3: Edit priority,Step 3: Edit priority>>
 ...
 ** If any of the selected member volumes are associated with more than one reserved capacity object that stores snapshot images, the *Review Capacity* dialog box appears. Go to <<Step 2: Review capacity,Step 2: Review capacity>>.
 ** If none of the selected member volumes are associated with more than one reserved capacity object that stores snapshot images, the *Edit Priority* dialog box appears. Go to <<Step 3: Edit priority,Step 3: Edit priority>>.
...
. Click *Next*, and go to <<Step 3: Edit priority,Step 3: Edit priority>>.
+
