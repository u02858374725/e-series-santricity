---
permalink: sm-storage/task_create_snapshot_consistency_group_step_2.html
sidebar: sidebar
keywords: 
...
. Click *Next*, and go to xref:task_create_snapshot_consistency_group_step_3.adoc[Step 3: Edit settings].
