---
permalink: sm-storage/task_create_snapshot_volume_step_2.html
sidebar: sidebar
keywords: 
 ...
 ** If your snapshot volume is read/write, the Review Capacity dialog box appears. Go to xref:task_create_snapshot_volume_step_3.adoc[Step 3: Reserve capacity for a snapshot volume].
 ** If your snapshot volume is read only, the Edit Priority dialog box appears. Go to xref:task_create_snapshot_volume_step_4.adoc[Step 4: Edit settings for a snapshot volume].
