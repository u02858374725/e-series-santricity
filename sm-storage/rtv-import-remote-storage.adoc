...
sidebar: sidebar
keywords: SANtricity, 11.7, System Manager, E-Series, import, remote, storage
...
* For the local E-Series storage system, create or select a volume to be used for the data import. See link:create-volumes-storage.html[Create volumes]. The target volume must meet the following requirements:
