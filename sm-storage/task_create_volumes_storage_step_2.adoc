---
permalink: sm-storage/task_create_volumes_storage_step_2.html
sidebar: sidebar
keywords: 
...
. Click *Next*.
. If your workload is associated with a supported application type, enter the information requested; otherwise, go to xref:task_create_volumes_storage_step_3.adoc[Step 3: Add or edit volumes].
